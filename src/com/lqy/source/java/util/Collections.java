...
/**
    ...
    private static class SingletonList<E>
        extends AbstractList<E>
        implements RandomAccess, Serializable {  //SingletonList和ArrayList都继承了 AbstractList 类

        private static final long serialVersionUID = 3093736618740652951L;

        private final E element; //SingletonList中保存的是一个元素，而不是一个数组

        SingletonList(E obj)                {element = obj;} //初始化集合中唯一的元素

        public Iterator<E> iterator() {
            return singletonIterator(element);
        }

        public int size()                   {return 1;}  //只有一个元素，所以长度直接返回1

        public boolean contains(Object obj) {return eq(obj, element);} //直接判断该集合中的唯一元素和传过来的值是否相等

        public E get(int index) {
            if (index != 0)  //只有一个元素 所以只有下表为0的位置有值
    ...
    static boolean eq(Object o1, Object o2) {
        return o1==null ? o2==null : o1.equals(o2);  //第一个元素为null，直接根据第第二个元素是不是null判定结果。 妙啊
    }
